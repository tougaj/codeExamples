...
{supercluster}
    ...
    supercluster_constraints = """- Використовуй суперкластер лише для уточнення контексту, не дублюючи його зміст.
- Довідка має відображати саме підтематику (цей кластер), а не дублювати або узагальнювати зміст суперкластеру.""" if supercluster else ""
