...
""",
    """Wieczór rozpoczął się w eleganckim stylu, ale szybko przerodził się w imprezę, która trwała do wczesnych godzin porannych — event zakończył się dopiero około godz. 3.00. Szczęsny nie stronił od towarzystwa — znalazł czas na papierosa z przyjaciółmi, a także… pokaz swoich umiejętności bramkarskich, tyle że tym razem poza boiskiem.

Wojciech Szczęsny był pewien, że wytną to zdanie z jego filmu. Chodzi o kobiety

Wzruszający moment wydarzył się po koncercie żony bramkarza Mariny, gdy para pocałowała się namiętnie, co uchwyciło wiele kamer i aparatów. Do końca wieczoru Szczęsnemu towarzyszył jego przyjaciel Grzegorz Krychowiak czy kolega z czasów gry w reprezentacji Karol Linetty.

Wśród gości pojawili się także Monika Olejnik z partnerem, Roksana Węgiel z mężem, Quebonafide z partnerką Martyną Byczkowską, czy były selekcjoner reprezentacji Polski Czesław Michniewicz z żoną Grażyną.

Po zakończeniu imprezy na Szczęsnych czekało auto z kierowcą, które zawiozło ich do domu na warszawskim Wilanowie. Niestety, jak donosi świadek, pojazd poruszał się bez włączonych świateł mijania, co zgodnie z przepisami ruchu drogowego może skutkować mandatem w wysokości 300 zł i 4 punktami karnymi. Czy kierowca uniknie konsekwencji? To pozostaje otwarte.

Jedno jest pewne — premiera filmu "Szczęsny" nie tylko odsłoniła nowe oblicze piłkarza, ale także pokazała, że jego życie prywatne i medialne nadal budzi ogromne zainteresowanie.""",
    """野球日本代表は8日、11月15、16日に東京ドームで行われる韓国との強化試合に臨むメンバー28人を発表し、岡本和真（巨人）、牧秀悟両内野手（DeNA）、新人の金丸夢斗投手（中日）らが選ばれた。米大リーグ移籍を目指す村上宗隆内野手（ヤクルト）や、本塁打と打点の2冠に輝いた佐藤輝明内野手（阪神）は選出されなかった。

2連覇を狙う来年3月のワールド・ベースボール・クラシック（WBC）へ向けた、国内組の最終選考の場となる。井端弘和監督は二遊間と外野をポイントに挙げ、「国内組しかいないポジションがいくつかある。そこで勝ち抜いてほしい」と期待。状態の不安から今回招集を見送った選手もいることを明かし、過去に選出した選手も含めて見極めていくことになる。

強化試合は来年のWBC仕様で実施。投球間の時間制限「ピッチクロック」やバッテリー間のサイン伝達機器「ピッチコム」、拡大ベースを使用予定で、指揮官は「日本にはないルールで戦わないといけない。慣れてもらえれば」と狙いを口にした。代表選手は11月6～12日まで、宮崎市内で強化合宿を行う。""",
    """新华社太原10月7日电（记者许雄）记者从中国铁路太原局集团有限公司获悉，10月7日，能源动脉大秦铁路开始秋季集中修施工。此次集中修施工至10月26日结束，为期20天，为今冬明春电煤保供运输夯实线路基础。
