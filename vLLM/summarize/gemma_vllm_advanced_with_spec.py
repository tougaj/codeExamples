...
TARGET_MODEL = "google/gemma-3-12b-it"  # основна модель (точна)
DRAFT_MODEL = "google/gemma-3-4b-it"     # draft модель (швидка)
...
llm = LLM(
    ...
    # speculative_config={
    #     "model": DRAFT_MODEL,  # draft модель для генерації кандидатів
